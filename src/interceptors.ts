...
const resolveRequestUri = (req: ApiUri): ApiUri => {
  ...
  } if (typeof URL !== "undefined" && req instanceof URL) {
...
window.fetch = async (req: RequestInfo | URL, init?: RequestInit | undefined): Promise<Response> => globalFetch(resolveRequestUri(req), init);
